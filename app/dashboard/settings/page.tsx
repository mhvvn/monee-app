    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto px-4 py-8 h-full flex flex-col items-center justify-center min-h-[60vh]">
            <div className="bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden group w-full max-w-2xl">
                {/* Glow effects */}
                <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-emerald-500/10 blur-[80px] rounded-full pointer-events-none transition-all duration-700 group-hover:bg-emerald-500/20" />
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-cyan-500/10 blur-[80px] rounded-full pointer-events-none transition-all duration-700 group-hover:bg-cyan-500/20" />

                <div className="relative z-10 flex flex-col items-center">
                    <div className="relative mb-8">
                        <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500 to-cyan-500 blur-xl opacity-20 rounded-full animate-pulse" />
                        <div className="bg-neutral-950 border border-neutral-800 p-6 rounded-full relative z-10 shadow-inner">
                            <Settings className="h-16 w-16 text-neutral-400 animate-[spin_10s_linear_infinite]" />
                    ...
                    <p className="text-neutral-400 text-lg leading-relaxed max-w-md mx-auto mb-8">
                        Fitur konfigurasi akun, tema gelap/terang, dan preferensi aplikasi monee sedang dalam tahap pengembangan oleh tim teknis kami.
                    </p>
