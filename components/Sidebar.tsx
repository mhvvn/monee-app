...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                className={`w-64 bg-neutral-900 border-r border-neutral-800 h-screen flex flex-col fixed left-0 top-0 z-50 transition-transform duration-300 ease-in-out md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
